...
btn1 = Button(calculator, text="Add", command=add, height=2, width=20, bg="black", fg="white")
btn2 = Button(calculator, text="Sub", command=sub, height=2, width=20, bg="black", fg="white")
btn3 = Button(calculator, text="Multiply", command=multi, height=2, width=20, bg="black", fg="white")
btn4 = Button(calculator, text="Divide", command=div, height=2, width=20, bg="black", fg="white")
